<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['order:deliveryRecord:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['order:deliveryRecord:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['order:deliveryRecord:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="deliveryRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="配送编号" align="center" prop="id" />
